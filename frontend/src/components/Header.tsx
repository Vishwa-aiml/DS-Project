          ...
          <div className="relative ml-1">
            {user ? (
                  ...
                  >
                    <div className="flex items-center gap-3 pb-3 border-b border-[#EAF2ED]">
                      ...
                      <div className="overflow-hidden">
                        <div className="text-sm font-bold text-[#14432A] truncate">{user.name}</div>
                        <div className="text-xs text-[#5D7769] truncate">{user.email}</div>
                      </div>
                    </div>
                    ...
                    <div className="mt-3 pt-2 border-t border-[#EAF2ED]">
                      ...
                      <button
                        ...
                        className="w-full mt-1 text-left px-2.5 py-1.5 text-xs font-semibold text-red-700 hover:bg-red-50 rounded-lg transition-colors flex items-center justify-between"
                      >
                        <span>Sign Out</span>
                      </button>
                    </div>
              ...
              <button
                ...
                className="bg-[#184E32] hover:bg-[#14432A] text-white font-bold py-1.5 px-5 rounded-full shadow-md transition-all flex items-center gap-2 text-sm cursor-pointer"
              >
                Join
              </button>
            )}
